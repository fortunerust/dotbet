...
function GameUpload({open, setOpen, title}) {
    ...
    return (
        <>
            <Transition.Root show={open && title==='game'} as={Fragment}>
                                    ...
                                    <div className='right-side px-8 w-full py-10 text-left'>
                                        <form action="#" onSubmit={handleSubmit} className="flex flex-col h-full">
                                            ...
                                            <div className="input-wrapper mt-2 mb-2">
                                                ...
                                                <input type="text" placeholder="BG-LIVE-00" value={game.gameCode} id="gameCode" className="rounded-lg px-6 mt-3" onChange={handleChange} />
                                            </div>
                                            <div className="input-wrapper mt-2 mb-2">
