...
export default function RegisterPhone({open, setOpen, title, setTitle}) {
                ...
                <div className='right-side px-8 py-10 text-left'>
                  <form action="#" className="flex flex-col h-full">
                    ...
                    <div className="grid grid-cols-2 tabs-wrapper gap-3 mb-5">
                      <button className="rounded-lg " onClick={onRegisterEmail}>Email</button>
                      <button className="rounded-lg active">Phone Number</button>
                    </div>
                    <div class="input-wrapper">
                      <label for="phone">Phone Number</label>
                      <div class="flex  mt-3 items-center">
                        <div class="FlagSelect relative mr-2">
                          <div class="head flex rounded-lg cursor-pointer items-center justify-center">
                            <img src={flag_icon} alt="flag" class="mr-2 w-6" />
                            <img src={dropdown_icon} alt="selectDropdown" />
                          </div>
                          <ul class="list-flag-select z-10 rounded-lg absolute w-full">
                        ...
                        <input type="tel" placeholder="Phone Number" id="phone" class="rounded-lg px-6 flex-1" />
                      </div>
                    </div>
